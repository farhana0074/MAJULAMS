...
public class HodLeavesWithoutPayDetails extends BackableFragment {


    public HodLeavesWithoutPayDetails() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       final View view =inflater.inflate(R.layout.fragment_hod_sl_n_lwp, container, false);
        ...
        if (bundle!= null)
        {
            ...
            LWPKey = bundle.getString("LWPKey");
        }
                            ...
                            btnApprove.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(!isEmpty(etComments)) {
                                        ...
                                        ((DatabaseReference) queryLWPNode).child("HoDApproval").setValue("Approved");
    ...
    public void onBackButtonPressed() {
        ...
        fragmentTransaction.remove(HodLeavesWithoutPayDetails.this).commit();
