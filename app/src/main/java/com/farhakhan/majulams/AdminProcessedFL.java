...
public class AdminProcessedFL extends BackableFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_admin_processed_fl, container, false);
        ...
        if (bundle!= null)
        {
            ...
            FLKey = bundle.getString("FLPrKey");
        }
        ...
        queryFLNode.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                final FLforAdminApprovl fLforAdminApprovl = dataSnapshot.getValue(FLforAdminApprovl.class);
                ApplicantEmail = fLforAdminApprovl.EmployeeEmail;
                mDbReference.child("Users").child("Faculty").child(ApplicantEmail).child("Domain")
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot2) {
                                ...
                                TextView tvApplicantDomainFL = view.findViewById(R.id.tvApplicant_domain_admin_pr_fl);
                                ...
                                ((DatabaseReference) queryInfo).child("Info").addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot3) {
                                        ...
                                        TextView tvApplicantNameFL = view.findViewById(R.id.tvApplicant_name_admin_pr_fl);
                                        tvApplicantNameFL.setText(ApplicantName);

                                        ApplicantPic = userNamePic.PicUrl;
                                        CircleImageView civImage = view.findViewById(R.id.iv_person_pic_admin_pr_fl);
                                ...
                                ((DatabaseReference) queryInfo).child("Designation").addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot4) {
                                        ...
                                        TextView tvApplicantDesigFL = view.findViewById(R.id.tvApplicant_desig_admin_pr_fl);
                ...
                LeaveType = fLforAdminApprovl.LeaveType;
                TextView tvLeaveType = view.findViewById(R.id.tvLeave_Type_admin_pr_fl);
                tvLeaveType.setText(LeaveType);

                strAppInTime = fLforAdminApprovl.LeaveApplyingTime;
                try {
                ...
                TextView tvAppTime = view.findViewById(R.id.tvAppTime_admin_pr_fl);
                tvAppTime.setText(strAppOutTime);

                strAppInDate = fLforAdminApprovl.LeaveApplyingDate;
                try {
                ...
                TextView tvAppDate = view.findViewById(R.id.tvAppDate_admin_pr_fl);
                tvAppDate.setText(strAppOutDate);

                strBInDate = fLforAdminApprovl.LeaveBeginningDate;
                try {
                ...
                TextView tvBDate = view.findViewById(R.id.tvLeave_BDate_admin_pr_fl);
                tvBDate.setText(strBOutDate);

                strEInDate = fLforAdminApprovl.LeaveEndingDate;
                try {
                ...
                TextView tvEDate = view.findViewById(R.id.tvLeave_EDate_admin_pr_fl);
                ...
                TextView tvTotalLeaveDays = view.findViewById(R.id.tv_TotalLvDays_admin_pr_fl);
                tvTotalLeaveDays.setText("Total Leave Days: " + diffDates );

                LeaveManage = fLforAdminApprovl.HowToCover;
                TextView tvManage = view.findViewById(R.id.tvLeave_C_Opt_admin_pr_fl);
                tvManage.setText(LeaveManage);

                LeaveComments = fLforAdminApprovl.CommentsOpt;
                TextView tvComments = view.findViewById(R.id.tvComments_admin_pr_fl);
                tvComments.setText(LeaveComments);

                HodComments = fLforAdminApprovl.HodComments;
                TextView tvHodComments = view.findViewById(R.id.tvCommentsHod_admin_pr_fl);
                tvHodComments.setText(HodComments);

                HodApprovl = fLforAdminApprovl.HoDApproval;
                TextView tvHodApprovl = view.findViewById(R.id.textView2_admin_pr_approval_fl);
                tvHodApprovl.setText(HodApprovl+" by HoD");

                BottomNavigationView bnvHodFullLeave = view.findViewById(R.id.bnv_admin_pr_fl);
