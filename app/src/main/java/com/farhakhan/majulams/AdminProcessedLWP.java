...
public class AdminProcessedLWP extends BackableFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle!= null)
        {
            ...
            LWPKey = bundle.getString("LWPPrKey");
        }
        ...
        queryLWPNode.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                final SLnLWPforAdminApprovl lwPforAdminApprovl = dataSnapshot.getValue(SLnLWPforAdminApprovl.class);
                ApplicantEmail = lwPforAdminApprovl.EmployeeEmail;
                ...
                strAppInTime = lwPforAdminApprovl.LeaveApplyingTime;
                try {
                ...
                strAppInDate = lwPforAdminApprovl.LeaveApplyingDate;
                try {
                ...
                strBInDate = lwPforAdminApprovl.LeaveBeginningDate;
                try {
                ...
                strEInDate = lwPforAdminApprovl.LeaveEndingDate;
                try {
